...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_BL] = ANSI_KEYMAP(
        ...
        KC_LCTL, KC_LGUI, KC_LALT,            KC_SPC,            KC_RALT, KC_TRNS, MO(_FL), KC_LEFT, KC_DOWN, KC_RIGHT),
  ...
  [_FL] = ANSI_KEYMAP(
      ...
      KC_TRNS,    F(3), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_HOME, KC_END, KC_TRNS, KC_TRNS, KC_PGUP, KC_TRNS, \
